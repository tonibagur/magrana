...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Gift.product'
        raise RuntimeError("Cannot reverse this migration. 'Gift.product' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Gift.product'
