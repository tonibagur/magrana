...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gift.email'
        db.add_column(u'Pomelo_gift', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)

        # Adding field 'Gift.state'
        db.add_column(u'Pomelo_gift', 'state',
                      self.gf('django.db.models.fields.CharField')(default='draft', max_length=20),
                      keep_default=False)

        # Adding field 'Gift.youtube_embed'
        db.add_column(u'Pomelo_gift', 'youtube_embed',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gift.email'
        db.delete_column(u'Pomelo_gift', 'email')

        # Deleting field 'Gift.state'
        db.delete_column(u'Pomelo_gift', 'state')

        # Deleting field 'Gift.youtube_embed'
        db.delete_column(u'Pomelo_gift', 'youtube_embed')
    ...
    models = {
        'Pomelo.gift': {
            ...
            'receiver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'receiver'", 'null': 'True', 'to': "orm['Pomelo.PomeloUser']"}),
            ...
            'youtube_embed': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True'})
        },
        'Pomelo.pomelouser': {
