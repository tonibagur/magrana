...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'Pomelo_gift', 'name')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Gift.name'
        raise RuntimeError("Cannot reverse this migration. 'Gift.name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Gift.name'
        db.add_column(u'Pomelo_gift', 'name',
